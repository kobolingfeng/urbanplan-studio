...
- 删除对象时阻止产生出入口悬挂引用。
- 新增 `smoke:geometry`、`smoke:upf`、`smoke:rules`、`smoke:rule-fixtures`、`smoke:evaluation`、`smoke:geojson`、`smoke:csv`、`smoke:markdown`、`smoke:static`、`smoke:release` 和 `verify` 脚本。
