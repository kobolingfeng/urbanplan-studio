...
5. Extend CI with signed release checks, installer generation, and versioned release publishing.
...
3. CSV import column templates and stricter value-range validation.
