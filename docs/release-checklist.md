...
- Click quality and confirm it includes UPF structure validation, rule catalog metadata, evidence distribution, structured evidence coverage, and import audit.
...
- Data quality report exposes rule catalog, prototype rules, evidence coverage, structured evidence coverage, evidence type distribution, and evidence gaps.
