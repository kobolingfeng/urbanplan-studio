...
for (const token of ['panCanvas', 'zoomCanvas', 'resetCanvasView', 'shiftKey', 'unmatchedParcelIds', 'invalidFields', 'normalizeNumberInput', 'finiteNumberOr(value, fallback)', '控制建筑密度', '控制绿地率', 'referencedEntrancesForObject', 'ui.btnDelete.disabled = !object;', 'numberInRangeOr', 'normalizeParcelScenarioValue', 'normalizeImportedObjectId', 'normalizedObjectForSnapshot', 'sanitizeDefaultName', 'reservedWindowsDefaultNamePattern', 'String(value ?? \'\')', 'nextUniqueId', 'runtimeIdCounter', 'autosaveTimer = undefined', 'ROAD_IMPORT_RANGES', 'FACILITY_IMPORT_RANGES', 'hasImportIdentifier', 'normalizeImportedReferenceId', 'normalizeImportedScenario', 'scenarioValueFor']) {
