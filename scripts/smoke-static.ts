...
for (const token of ['panCanvas', 'zoomCanvas', 'resetCanvasView', 'shiftKey', 'unmatchedParcelIds', 'invalidFields', 'normalizeNumberInput', '控制建筑密度', '控制绿地率', 'referencedEntrancesForObject', 'ui.btnDelete.disabled = !object;']) {
